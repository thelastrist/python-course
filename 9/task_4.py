...
raws=int(input("Введите кол-во рядов: "))
seats_in_raw=input("Введите кол-во сидений ряду: ")
meters=input("Введите кол-во метров между рядами: ")

for i in range(0, raws):
    print("=" * seats_in_raw, "*" * meters, "=" * seats_in_raw)
